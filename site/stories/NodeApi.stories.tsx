...
import type { SubsystemThroughline } from '@principal-ai/principal-view-react/dist/subsystem/model.js';
...
const throughlines: SubsystemThroughline[] = [
  {
    ...
    title: 'POST /orders',
    steps: [
      { edgeId: 'e0', file: 'src/routes/orders.ts', line: 14, symbol: "router.post('/orders')" },
      { edgeId: 'e4', file: 'src/services/orderService.ts', line: 23, symbol: 'reserveIdempotencyKey' },
      { edgeId: 'e2', file: 'src/services/orderService.ts', line: 31, symbol: 'capturePayment' },
      { edgeId: 'e1', file: 'src/services/orderService.ts', line: 38, symbol: 'saveOrder' },
      { edgeId: 'e3', file: 'src/repositories/orderRepository.ts', line: 12, symbol: 'insert' },
    ],
  },
];
