...
```jsonc
{
  "title": "Principal Studio session service",        // required
  "description": "Optional one-liner.",
  "source": "agent:<your-name>",                   // optional provenance
  "repo": { "owner": "principal-ai", "name": "principal-view-core-library" },
  ...
  "components": [                                  // required
    {
      ...
      "file": "packages/principal-studio/src/bun/server-sessions.ts",  // repo-relative
      "purl": "pkg:github/principal-ai/principal-view-core-library#packages/principal-studio/src/bun/server-sessions.ts",
      ...
      "steps": [
        {
          ...
          "file": "packages/principal-studio/src/bun/server-sessions.ts",
...
- `process` groups nodes into boundary regions (e.g. `principal-studio/host` vs
