...
const cases: DemoCase[] = [
	{
		...
		file: 'packages/principal-studio/src/mainview/excalidraw/subsystemToExcalidraw.ts',
	...
	},
	{
		...
		file: 'packages/principal-studio/src/mainview/excalidraw/excalidrawToSubsystem.ts',
	...
	{
		label: 'analyzeBeats',
		file: 'packages/principal-studio/src/bun/beat-analysis.ts',
		symbol: 'analyzeBeats',
		claimed: {
	...
	},
	{
		...
		file: 'packages/principal-studio/src/mainview/views/AgentSessions.tsx',
