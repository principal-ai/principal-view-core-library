...
const reactUiComponents: SubsystemComponent[] = [
  ...
  },
  {
    ...
    name: 'AnalysisView',
    construct: 'function',
    file: 'packages/principal-studio/src/mainview/views/AnalysisView.tsx',
    purl,
    symbol: 'AnalysisView',
  ...
  },
  {
    ...
    construct: 'function',
    file: 'packages/principal-studio/src/mainview/hooks/useDrawingsHost.ts',
    purl,
  ...
  },
  {
    ...
    file: 'packages/core/src/types/subsystem-model.ts',
    purl,
